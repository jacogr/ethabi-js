...
Event = function () {
  function Event(abi) {babelHelpers.classCallCheck(this, Event);
    ...
    this._signature = eventSignature(this._name, this.inputParamTypes());}babelHelpers.createClass(Event, [{ key: 'inputParamTypes', value: function inputParamTypes() 
    ...
    topics, data) {
      ...
      return new DecodedLog(decodedParams, address);} }, { key: 'name', get: function get() {return this._name;} }, { key: 'inputs', get: function get() {return this._inputs;} }, { key: 'anonymous', get: function get() {return this._anonymous;} }, { key: 'signature', get: function get() {return this._signature;} }]);return Event;}();
...
Func = function () {
  function Func(abi) {babelHelpers.classCallCheck(this, Func);
    ...
    tokens) {
      return '' + this._signature + Encoder.encode(tokens);} }, { key: 'decodeOutput', value: function decodeOutput(
...
module.exports = EthAbi;/* Thu Jun  2 11:20:37 UTC 2016 */
